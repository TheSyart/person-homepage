...
date: 2025-09-27
summary: "用 Flutter、视频逐帧处理和 ML Kit 完成篮球动作识别，串起帧提取、人体关键点、骨骼绘制、状态判断与拍球计数。"
tags: []
draft: false
cover: /assets/clay/articles/pose-detection.png
coverAlt: "Flutter 集成 Google ML Kit 体态识别模型 (二) 如何用姿态数据实现运动动作检测文章封面"
---
