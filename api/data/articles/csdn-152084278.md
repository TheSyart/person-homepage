...
date: 2025-09-25
summary: "比较 Flutter 液态玻璃效果的两种实现路径：手写 Shader 与现成组件库，并通过示例分析折射、模糊、拖拽和性能取舍。"
tags: []
draft: false
cover: /assets/clay/articles/liquid-glass.png
coverAlt: "Flutter Liquid Glass 魔法指南：让你的界面闪耀光彩文章封面"
---
