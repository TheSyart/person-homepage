...
date: 2025-10-16
summary: "解释依赖、依赖注入与服务定位的区别，并逐步演示 Get.put、Get.lazyPut、Get.find 等 GetX 依赖管理方式及生命周期。"
tags: []
draft: false
cover: /assets/clay/articles/getx-dependency.png
coverAlt: "Flutter 之魂 GetX（三）深入掌握依赖管理文章封面"
---
