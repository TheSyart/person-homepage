...
date: 2026-05-18
summary: "上一篇我们把 Agent 理解成“模型 + 运行时 + 工具 + 观察”的行动闭环。这一篇开始落到代码：先调通一次模型 API，再加对话循环、history、system prompt、tool use 和 skills。你会看到，一个最小 Agent 不是从框架里变出来的，而是从几层非常朴素的控制流里长出来的。"
